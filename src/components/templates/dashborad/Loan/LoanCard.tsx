...
export default function LoanCard() {
  ...
  const [isOpenInstallments, setIsOpenInstallments] = useState<boolean>(true);
  return (
        ...
        <div className="relative inset-0 z-20 rounded-3xl">
          ...
          <div className="flex flex-col gap-4 px-12">
            <div className="flex items-center justify-between">
              ...
              <p className="text-white text-2xl proportional-nums">
            ...
            <div className="flex items-center justify-between">
              ...
              <p className="text-white text-[1.05rem] proportional-nums">
                ۱۴۰۴/۰۹/۱۰
              </p>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className={`text-white w-8 h-8 rounded-full flex justify-center items-center ${
                  isPendding ? "bg-yellow-400" : "bg-[var(--color-primary)]"
            ...
            <div className="mt-2 mx-auto w-2/3 flex gap-x-2 justify-center items-center p-2.5 text-white rounded-xl shadow-lg shadow-black/20 bg-zinc-600 cursor-pointer">
              <span>مشاهده اقساط</span>
              <IconDownArrow size="w-4 h-4" color="#fff" />
            </div>
          </div>
        </div>
      </div>
